          ...
          return (
            <>
              <div className="md:flex md:mx-20">
                ...
                <div className="xs:flex-col md:ml-20 md:p-6 md:mx-20 ">
                  ...
                  <div className="data 2xs:mt-3 xs:mb-3 md:mx-20">
              ...
              <div className="text-left md:mx-20">
                <p className="2xs:mt-2 font-medium md:mt-3 xs:text-xl sm:text-2xl">
                  Product Details
                </p>
                <p className="2xs:text-sm text-gray-600 xs:text-xs xs:font-normal sm:text-xl sm:mt-2 md:text-sm md:w-[500px] md:mb-0">
