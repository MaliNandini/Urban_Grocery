...
export const ProductDetails = () => {
  ...
  const { id } = useParams();
  mockProduct[0].data.filter((data) => {
    return data.id === id;
  });
  ...
  return (
    ...
    <div className="flex mt-10 p-16 justify-between">
       {productPageData && productPageData.map((items,index)=>{
          return (
            <>
            <div className="flex flex-col bg-white dark:bg-neutral-700" key={index}>
              ...
              <div className="text-left">
                ...
                <p className="text-gray-600">
                  tepary Beans Flour (43%), Edible Vegetable Oil, Gram Pulse Flour
                  (12%), Edible <br /> Common Salt Powder, Black Pepper Powder, Ginger
                  Powder, Clove Powder, Mace <br /> Powder, Nutmeg Powder & Cardamom
                  Powder
                </p>
                ...
                <ul className="text-gray-600">
                  <li>
                    Gets Easily digested, hence does no harm to the digestive systme.
                  </li>
            ...
            </div><div className="flex flex-col mr-24 al p-6">
                <nav
